...
Function Set-Speaker($Volume){$wshShell = new-object -com wscript.shell;1..50 | % {$wshShell.SendKeys([char]174)};1..50 | % {$wshShell.SendKeys([char]175)}}
...
$action2 = New-ScheduledTaskAction -Execute 'Powershell.exe' -Argument "setspeaker"
